  ...
  return (
    <div ref={containerRef} className="relative min-w-0 w-full max-w-full">
      <button
        ...
        aria-expanded={open}
        className="flex w-full min-w-0 max-w-full items-center gap-1.5 rounded-full border border-slate-200 bg-white/80 py-1.5 pr-1.5 pl-2.5 text-left shadow-sm backdrop-blur transition hover:border-sky-300 hover:bg-white focus:ring-2 focus:ring-sky-500/25 focus:outline-none dark:border-slate-700 dark:bg-slate-800/80 dark:hover:border-sky-600 dark:hover:bg-slate-800"
      >
        <PinIcon />
